...
<div class="content">
    <div class="container">
      <h1 class="title">글 등록하기</h1>
      	<form action="${path1 }/AddYearCtrl.do" method="post">
			<table class="table">
			   <tbody>
			    <tr>
			    ...
			    <tr>
			      ...
			      <td><input type="text" class="input" maxlength="120" name="ydisD" id="ydisD" required /></td>
			    </tr>
			    <tr>
			    ...
			    <tr>
			      ...
			      <td><input type="text" class="input" maxlength="120" name="period" id="period" required /></td>
			    </tr>
			    <tr>
